...
\textsc{\huge{} for Solving Nonlinear }\\
\textsc{\huge Neutronics/Thermal Hydraulic Equations}\textsc{}\\
\textsc{}\\
...
\begin{figure}[H]
\begin{centering}
\scalebox{0.7}{\input{./tikz/absxs.tikz}}
\par\end{centering}
...
\begin{figure}[H]
\begin{centering}
\scalebox{0.7}{\input{./tikz/nfiss.tikz}}
\par\end{centering}
...
\begin{figure}[H]
\begin{centering}
\scalebox{0.7}{\input{./tikz/diff.tikz}}
\par\end{centering}
...
\begin{figure}[H]
\begin{centering}
\scalebox{0.7}{\input{./tikz/kfiss.tikz}}
\par\end{centering}
...
An animation of this transient is shown in Fig. \ref{fig:anim}. 
\begin{figure}
\begin{centering}
\input{./tikz/anim.tikz}
\par\end{centering}
